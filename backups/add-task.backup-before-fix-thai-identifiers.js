  ...
  return (
    <View style={styles.screen}>
      ...
      >
        ...
        <View style={styles.card}>
          <Text style={styles.sectionชื่องาน}>ประเภทงาน</Text>
        ...
        <View style={styles.card}>
          <Text style={styles.sectionชื่องาน}>Time Management</Text>

          <Text style={styles.subSectionชื่องาน}>ความสำคัญ</Text>
          ...
          <Text style={styles.subSectionชื่องาน}>Estimated Duration</Text>
        ...
        <View style={styles.card}>
          <View style={styles.planningHeader}>
            <View style={styles.planningชื่องานBox}>
              <Text style={styles.sectionชื่องาน}>โหมดวางแผน</Text>
          ...
          {planningEnabled && (
            <>
              ...
              <Text style={styles.subSectionชื่องาน}>เวลาที่ต้องใช้ทั้งหมด</Text>
              ...
              <Text style={styles.subSectionชื่องาน}>ระยะเวลาต่อครั้ง</Text>
              ...
              <Text style={styles.subSectionชื่องาน}>Plan Before กำหนดส่ง</Text>
              ...
              >
                <View>
                  <Text style={styles.optionชื่องาน}>
                    ให้แอปจัดรอบอ่าน
                  </Text>
              ...
              <View style={styles.line} />
                            ...
                            <Text style={styles.subSectionชื่องาน}>ช่วงเวลาที่สะดวกอ่าน</Text>
...
<Pressable
              ...
              >
                <View>
                  <Text style={styles.optionชื่องาน}>Add review session</Text>
                  <Text style={styles.optionSubtitle}>
        ...
        <View style={styles.card}>
          <Text style={styles.sectionชื่องาน}>การทำซ้ำ</Text>
          ...
          {repeatType === RECURRENCE_TYPES.WEEKLY && (
            <>
              ...
              <Text style={styles.subSectionชื่องาน}>การทำซ้ำ on</Text>
