...
export default function AddTask() {
  ...
  const academicTaskTypeOptions = [
    {
      label: "Normal",
      value: "normal",
      description: "General task or personal schedule",
    },
    {
      label: "Class",
      value: "class",
    ...
    },
    {
      label: "Exam",
      value: "exam",
      description: "Exam or important deadline",
    },
    {
      label: "Study Plan",
      value: "study_plan",
      description: "Generate study sessions automatically",
    },
  ];
  ...
  const handleAcademicTaskTypeChange = (nextType) => {
    ...
    if (nextType === "class") {
      ...
      setRepeatType(RECURRENCE_TYPES.WEEKLY);
  ...
  const getTaskTypeForPayload = () => {
    ...
    if (academicTaskType === "class") return "class";
  ...
  const handleRepeatTypeChange = (nextType) => {
    ...
    if (academicTaskType === "class" && nextType !== RECURRENCE_TYPES.WEEKLY) {
      Alert.alert(
        "Class Schedule",
        "Class schedule should use Weekly repeat."
      );
      return;
    }
  ...
  const handleSave = async () => {
    ...
    if (academicTaskType === "class" && repeatType !== RECURRENCE_TYPES.WEEKLY) {
      Alert.alert(
        "Error",
        "Class Schedule must use Weekly repeat."
      );
      return;
    }
    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          {academicTaskType === "class" ? (
            <Text style={styles.helpText}>
              Class type will use weekly repeat. Select the class weekday in the Repeat section.
            </Text>
          ) : null}

          {academicTaskType === "exam" ? (
            <Text style={styles.helpText}>
              Exam type is used as a fixed event and can be used as a deadline for study planning.
            </Text>
          ) : null}

          {academicTaskType === "study_plan" ? (
            <Text style={styles.helpText}>
              Study Plan will generate smaller study sessions before the deadline.
            </Text>
          ) : null}
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.helpText}>
            Priority, deadline, and estimated duration will be used for smart
        ...
        <View style={styles.card}>
          <View style={styles.planningHeader}>
            <View style={styles.planningTitleBox}>
              <Text style={styles.sectionTitle}>Planning Mode</Text>
          ...
          {planningEnabled && (
            <>
              ...
              <Text style={styles.subSectionTitle}>Total Duration</Text>
              ...
              <Text style={styles.subSectionTitle}>Plan Before Deadline</Text>
              ...
              <View style={styles.durationContainer}>
                {beforeDeadlineOptions.map((day) => (
                  <Pressable
                    ...
                    onPress={() => setPlanBeforeDeadlineDays(day)}
                  >
                    <Text
                      style={[
                        styles.durationText,
              ...
              <View style={styles.planningSummaryBox}>
                <Text style={styles.planningSummaryTitle}>Planning Summary</Text>
